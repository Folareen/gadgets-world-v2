...
const Search = () => {
    ...
    const handleSearch = () => {
        ...
        if(filters.category || filters.priceRange.min || filters.priceRange.max){
            let url = `http://localhost:1337/api/products?populate=*&filters[title][$contains]=${searchTerm}`
                if(filters.category){
            ...
            search(`http://localhost:1337/api/products?populate=*&filters[title][$contains]=${searchTerm}`)
        }
    }
    ...
    const removeFilters = () => {
        ...
        search(`http://localhost:1337api/products?populate=*&filters[title][$contains]=${searchTerm}`)
    }
